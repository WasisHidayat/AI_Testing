...
WebUI.click(findTestObject('Object Repository/CURA Health login/Page_CURA Healthcare Service/a_Make Appointment'))

WebUI.setText(findTestObject('Object Repository/CURA Health login/Page_CURA Healthcare Service/input_username'), 'John Doe')
